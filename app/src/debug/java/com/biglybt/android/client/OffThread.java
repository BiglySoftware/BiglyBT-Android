...
public class OffThread
{
	...
	public static void runOnUIThread(
		...
		// WrongThreadInterprocedural can't determine that 
		//    isUIThread() { runrable.run(); }
		// is actually on UiThread (it is!)
		// Use Handler.post which removes the incorrect WrongThreadInterprocedural warning
	...
	public static boolean runOffUIThread(
			@NonNull RunnableWorkerThread workerThreadRunnable) {
	...
	public static void runOnUIThread(@NonNull final Fragment fragment,
			...
			final @NonNull RunnableWithActivity<Activity> runnable) {
