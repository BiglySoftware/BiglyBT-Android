...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            mInputText.setSaveFromParentEnabled(false);
        }
        mInputText.setSaveEnabled(true);
        ...
        /* this project had this line instead:
                    ...
                    case KeyEvent.ACTION_DOWN:
                        if (mWrapSelectorWheel || ((keyCode == KeyEvent.KEYCODE_DPAD_DOWN)
                            ...
                            if (mFlingScroller.isFinished()) {
                                ...
                                long repeatCount = (event.getEventTime() - event.getDownTime()) / SNAP_SCROLL_DURATION;
                                if (repeatCount >= 5) {
                                    int step = (int) Math.min((repeatCount / 5) + 1, (mMaxValue - mMinValue) / 10);
                                    int v = mValue + (keyCode == KeyEvent.KEYCODE_DPAD_DOWN ? step : -step);
        ...
        public CharSequence filter(
            ...
            if (mDisplayedValues == null) {
                ...
                if (val > mMaxValue || result.length() > String.valueOf(mMaxValue).length()) {
                    ...
                    /* Disabled because OnValueChangeListener doesn't get fired
