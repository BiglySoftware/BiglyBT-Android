 ...
 */
public final class ObjectTypeAdapterLong extends TypeAdapter<Object> {
  public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() {
    @SuppressWarnings("unchecked")
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
    	System.out.println("RAW TYPE=" + type.getRawType());
      if (type.getRawType() == Map.class) {
        return (TypeAdapter<T>) new ObjectTypeAdapterLong(gson);
      }
      return null;
    }
  };
  ...
  private ObjectTypeAdapterLong(Gson gson) {
